...
<div className="w-full">
    {/* <nav className="bg-white shadow-lg">
        <div className="md:flex items-center justify-between py-2 px-8 md:px-12">
            ...
            <div className="flex flex-col md:flex-row sm:hidden md:block -mx-2">
    ...
    <div className="flex bg-white h-[600px]" >
        <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
            <div>
                ...
                <p className="mt-2 text-base font-mono font-medium italic  text-gray-500 md:text-lg">Here you can share some memories that happened in your life with people, so that people can remember your events,</p>
                <div className="flex justify-center lg:justify-start mt-6">
                
                 <Link to={'/addBlog'}>
                 <button  className="px-4 py-3 bg-gray-900 text-gray-200 text-xs font-semibold rounded hover:bg-gray-800" >Add blog</button>
                 </Link>
                 <Link to={"/allBlog"}>   <button className="mx-4 px-4 py-3 bg-gray-300 text-gray-900 text-xs font-semibold rounded hover:bg-gray-400" >Read Blog</button></Link>
                </div>
            </div>
        </div>
        <div className="hidden lg:block lg:w-1/2" style={{clipPath: `polygon(10% 0, 100% 0%, 100% 100%, 0 100%)`}}>
            ...
            style={{backgroundImage: `url(https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1352&q=80)`}}>
