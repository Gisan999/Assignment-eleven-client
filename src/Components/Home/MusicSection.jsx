    ...
    return (
        <div className="bg-gray-100">
            <div className="flex max-w-screen-xl mx-auto items-center justify-center ">
                <div className="w-full px-5 lg:px-0 py-32">
                    <p className="text-center relative top-5 text-teal-500 text-5xl font-serif uppercase font-semibold">word of advice</p>
                    ...
                    <div className="bg-white border-slate-100 dark:bg-slate-800 dark:border-slate-500 border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8  items-center">
                        <div className="flex items-center space-x-4">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7MzpRIKVPBQWKyiNPVVrcH5W4jBd_mlCtsfvfIdT0mBISLDq0nXp87J0TYa0DmAqx558&usqp=CAU" alt="" width="88" height="88" className="flex-none rounded-lg bg-slate-100" loading="lazy" />
