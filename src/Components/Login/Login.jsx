                ...
                <div className="container h-full px-6 py-12 lg:py-24">
                    <div
                        ...
                        <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
                            ...
                            <p className="text-center mt-5">If there is no account<Link to={'/registration'} className="text-base hover:text-blue-600 hover:underline hover:font-semibold"> Registration</Link></p>
